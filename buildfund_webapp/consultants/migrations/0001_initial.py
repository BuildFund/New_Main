# Generated by Django 4.1.13 on 2026-01-15 15:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_data', models.JSONField(blank=True, default=dict, help_text='Full company data from Companies House')),
                ('company_verified_at', models.DateTimeField(blank=True, null=True)),
                ('trading_address', models.TextField(blank=True)),
                ('directors_data', models.JSONField(blank=True, default=list, help_text='Directors from Companies House')),
                ('shareholders_data', models.JSONField(blank=True, default=list, help_text='Shareholders/PSCs from Companies House')),
                ...
                ('account_holder_role', models.CharField(blank=True, max_length=255)),
                ...
                ('primary_service', models.CharField(choices=[('valuation_and_monitoring_surveyor', 'Valuation & Monitoring Surveyor'), ('monitoring_surveyor', 'Monitoring Surveyor'), ('valuation_surveyor', 'Valuation Surveyor'), ('solicitor', 'Solicitor'), ('other', 'Other Professional Service')], help_text='Primary service type', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('service_type', models.CharField(choices=[('valuation_and_monitoring_surveyor', 'Valuation & Monitoring Surveyor'), ('monitoring_surveyor', 'Monitoring Surveyor'), ('valuation_surveyor', 'Valuation Surveyor'), ('solicitor', 'Solicitor')], max_length=50)),
