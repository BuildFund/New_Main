...
from .models import Application, ApplicationStatusHistory, ApplicationDocument, ApplicationUnderwriting, UnderwriterReport
...
class ApplicationViewSet(viewsets.ModelViewSet):
    ...
    def generate_underwriter_report(self, request, pk=None):
        ...
        try:
            service = UnderwriterReportService()
            report = service.generate_report(application, created_by=user)
